...
const LoveTimer = () => {
  ...
  const START_DATE_STRING = '2025-12-15';
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#52000d] flex flex-col items-center justify-center overflow-hidden font-sans select-none p-4 dir-rtl text-white">
      ...
      {/* 4. سكشن "أول مرة قولتلك بحبك" الجديد */}
      <motion.div
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.5, delay: 0.2 }}
        className="relative z-10 w-full max-w-[460px] mt-4 bg-gradient-to-b from-white/10 to-black/20 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-lg p-5 flex flex-col items-center gap-2 text-center"
      >
        <div className="flex items-center gap-2 text-pink-200 text-sm md:text-base font-bold">
          <span>💌</span>
          <span>أول مرة قولتلك بحبك</span>
          <span>💌</span>
        </div>
        <div className="text-lg md:text-xl font-extrabold text-white tracking-widest bg-white/10 px-4 py-1.5 rounded-full border border-white/10 shadow-inner">
          19-12-2025
        </div>
        <p className="text-xs text-pink-100/80 mt-1">
          اليوم اللي اتغيرت فيه كل حاجة للأنسب والأجمل ✨
        </p>
      </motion.div>
